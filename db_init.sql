...
15, 3),
(2, 'C002', 'Carne de Sol com Macaxeira', 'Carne de sol acebolada servida com macaxeira frita ou cozida.', 
'Prato Principal', 'Nordeste (Geral)', 'Carne de sol, macaxeira, manteiga de garrafa, cebola roxa', '450g', 700, 25, 8),
(3, 'C003', 'Vatapá', 'Creme de pão com camarão seco, leite de coco e azeite de dendê.', 
'Acompanhamento', 'Bahia', 'Pão, camarão seco, leite de coco, azeite de dendê, amendoim', '250g', 450, 18, 6);
